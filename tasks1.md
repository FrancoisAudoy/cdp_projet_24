...
|:--:|:-----:|:----------:|:-------------------:|:-------------------------------------:|:----------:|:-----------:|
| 1 | Créer un fichier "docker-compose.yml" qui permet de configurer le docker. | 1 | / | 0.5 | DONE | Charles |
| 2 | Implémenter le fichier "docker-compose.yml". | 5 | / | 2 | DONE | Charles |
| 3 | Créer un fichier "listProj.html" qui décrit la structure de l'affichage de la liste non-ordonnée (sans numéro de ligne) des projets. | 1 | 3 | 0.5 | DONE | François |
| 4 | Implémenter le fichier "listProj.html". | 2 | 3 | 0.5 | DOING | François |
| 5 | Créer un fichier "listProj.js" qui permet de récupérer la liste des projets depuis la base de données via la fonction "getAllProjects()" du fichier "query.js", et d'ajouter ses éléments dans le DOM de la page "listProj.html".  | 1 | 3 | 0.5 | DONE | François |
| 6 | Implémenter le fichier "listProj.js". | 2 | 3 | 0.5 | DOING | François |
| 7 | Créer un fichier "propProj.html" qui décrit la structure de l'affichage des propriétés d'un projet, c'est-à-dire un champ "Nom". | 1 | 4 | 0.5 | DONE| François |
| 8 | Implémenter le fichier "propProj.html". | 2 | 4 | 0.5 | DOING | François |
| 9 | Créer un fichier "propProj.js" qui permet de donner un nom à un projet via le champ "Nom" de la page "propProj.html" et de l'ajouter dans la base de données via la fonction "createProject(String name)" du fichier "query.js". Après avoir fini, il y a une redirection vers la page "listProj.html". | 1 | 4 | 0.5 | DONE | François |
| 10 | Implémenter le fichier "propProj.js". | 3 | 4 | 0.5 | DOING | François |
...
| 21 | Créer un fichier "server.js" qui sert de back-end à l'application. Il permet de gérer les interactions entre la base de données et les requếtes : il exécute les requêtes que le fichier "query.js" lui envoie, et retourne au format JSON les données récupérées sur la base de données. | 1 | / | 0.5 | DONE | François |
| 22 | Implémenter le fichier "server.js". | 5 | / | 2 | DOING | François |
...
| 24 | Créer un fichier "index.html" qui correspondra à notre page web d'entrée au site. Cette page contiendra seulement un bouton redirigeant vers la page listant les projets (listProj.html). | 1 | / | 0.5 | DONE | François |
| 25 | Implémenter le fichier "index.html" | 1 | / | 0.5 | DOING | François |
| 26 | Implémenter le fichier "cdp.db". | 2 | / | 0.5 | TODO | Charles |
| 27 | Ecrire le test pour pouvoir voir la liste des projets. | 3 | 3 | 1 | TODO | Maxime |
| 28 | Jouer le test précédent. | 1 | 3 | 0.5 | TODO | Maxime |
| 29 | Ecrire le test pour pouvoir créer un nouveau projet. | 3 | 4 | 1 | TODO | Maxime |
| 30 | Jouer le test précédent. | 1 | 4 | 0.5 | TODO | Maxime |
| 31 | Ecrire le test pour accéder au BackLog d'un projet. | 3 | 6 | 1 | TODO | Maxime |
| 32 | Jouer le test précédent. | 1 | 6 | 0.5 | TODO | Maxime |
| 33 | Ecrire le test pour ajouter une User Story à un projet. | 3 | 7 | 1 | TODO | François |
| 34 | Jouer le test précédent. | 1 | 7 | 0.5 | TODO | François |
| 35 | Ecrire le test pour modifier ou supprimer une User Story. | 3 | 8 | 1 | TODO | Charles |
| 36 | Jouer le test précédent. | 1 | 8 | 0.5 | TODO | Charles |
